...
- Critical: harness can report acceptance while hiding dirty dependency state.
- High: a gate reports success while skipping a required Strategy A or Strategy
  E check.
