...
check_local_text LlzkLean/Cert.lean '(llzkParityStatus := .aligned)' "Lean cert catalog marks constant_fold_add aligned"
check_local_text certs/felt-combine.cert.json '"patternId":"constant_fold_add"' "cert snapshot contains constant_fold_add"
check_local_text certs/felt-combine.cert.json '"llzkParityStatus":"aligned"' "cert snapshot records aligned status"
